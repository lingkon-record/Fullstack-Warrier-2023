...
const Test = () => {
    ...
    const calculate = () => {
        ...
        setResult(
            <div className="bg-gray-100 p-6 rounded-lg">
                <p className="text-lg mb-4">Your age: {myAge.years} years, {myAge.months} months, {myAge.days} days</p>
                <p className="text-lg mb-4">Wife's age: {wifeAge.years} years, {wifeAge.months} months, {wifeAge.days} days</p>
                <p className="text-lg mb-4">Age difference: {ageDifference.years} years, {ageDifference.months} months, {ageDifference.days} days</p>
                <p className="text-lg mb-4">{older}</p>
                <p className="text-lg">Marriage duration: {marriageDuration.years} years, {marriageDuration.months} months, {marriageDuration.days} days</p>
            </div>
        );
    };
    ...
    return (
        <div className="container mx-auto mt-8">
            <h1 className="text-3xl font-bold mb-8 text-center">Age and Marriage Duration Calculator</h1>
            <div className="flex flex-col items-center">
                <div className="w-full md:w-1/2 mb-4">
                    <label htmlFor="myDob" className="block mb-2 text-lg">Your Date of Birth:</label>
                ...
                <div className="w-full md:w-1/2 mb-4">
                    <label htmlFor="wifeDob" className="block mb-2 text-lg">Wife's Date of Birth:</label>
                ...
                <div className="w-full md:w-1/2 mb-4">
                    <label htmlFor="marriageDate" className="block mb-2 text-lg">Marriage Date:</label>
                ...
                <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-8 rounded-lg transition duration-300 ease-in-out transform hover:scale-105" onClick={calculate}>Calculate</button>
            </div>
            <div className="mt-8">
                {result}
            </div>
