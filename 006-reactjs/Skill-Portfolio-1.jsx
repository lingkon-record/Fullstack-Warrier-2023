  ...
  return (
    <div className="bg-gray-100 min-h-screen p-6">
      ...
      <header className="bg-white shadow-md py-4 px-6 mb-6">
        <h1 className="text-2xl font-bold text-gray-800">Lingkon's Portfolio</h1>
      </header>
      ...
      <main className="space-y-8">
        {/* Job Experience */}
        <section>
          <h2 className="text-xl font-semibold text-gray-800 mb-4">Job Experience</h2>
...
const Skill = ({ name }) => (
  <span className="inline-block bg-gray-200 text-gray-800 px-3 py-1 rounded-full text-sm font-medium">{name}</span>
);
